...
public class MessageTypeType implements java.io.Serializable {
    ...
    // Constructor
    protected MessageTypeType(java.math.BigInteger value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final java.math.BigInteger _value1 = new java.math.BigInteger("7");
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://gisis.imo.org/XML/LRIT/receipt/2008", "messageTypeType"));
    }
    /**
