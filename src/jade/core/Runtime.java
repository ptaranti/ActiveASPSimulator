...
public class Runtime {
	...
	public static String getVersion() {
		String version = "3.6"; // The $ surrounded Version keyword is automatically replaced by the target doTag of build.xml
		return version;
	}
	
	public static String getRevision() {
		String revision = "6032"; // The $ surrounded WCREV keyword is automatically replaced by WCREV with subversion
		return revision;
	}
	
	public static String getDate() {
		String date = "2008/05/05 14:07:10"; // The $ surrounded WCDATE keyword is automatically replaced by WCREV with subversion
		return date;
	}
}
